  ...
  xhttp.onreadystatechange = function() {
    if(!$.trim(this.responseText)){
      ...
      for(j=0;j<i;j++){
        ...
        cell2.innerHTML = "<button type='button' onclick='myfunction(this.id)' class='btn btn-link' id='"+j+"' data-bs-toggle='modal' data-bs-target='#myModal'>"+ dt[j.toString()]['fields']['name']+"</button>";
